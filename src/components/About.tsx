...
export function About() {
  return (
    ...
    >
      <div
        className="absolute top-0 left-0 w-full h-32 bg-gradient-to-b from-slate-50 to-transparent"
        aria-hidden="true"
      ></div>
      <div
        className="pointer-events-none absolute -top-24 -right-24 h-72 w-72 rounded-full bg-blue-400/20 blur-3xl"
        aria-hidden="true"
      />
      <div
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8 order-1 lg:order-2">
            <div className="space-y-4">
              ...
              >
                ...
                <span className="relative inline-block">
                  <span className="relative z-10 text-gradient from-cyan-600 to-blue-600">
                    Digital Excellence
                  </span>
                  <span
                    className="absolute bottom-2 left-0 w-full h-3 bg-cyan-200/50 -rotate-1"
                    aria-hidden="true"
                  ></span>
                </span>{" "}
                and Innovation
            ...
            <p className="text-lg text-slate-600 leading-relaxed">
              As an acclaimed digital marketing professional based in India,
              I've garnered recognition across diverse facets of the IT and
              digital marketing industry. My global reach extends to serving
              clients in over{" "}
            ...
            <p className="text-lg text-slate-600 leading-relaxed">
              I've successfully mastered the domains of web building and digital
              marketing, assuring the success of my client's enterprises and
              creating distinct brand experiences for their valued customers.
            </p>
            ...
            >
              {[
                ...
                <div key={index} className="group text-center" role="listitem">
                  <div
                    className={`bg-gradient-to-br ${item.color} w-16 h-16 rounded-2xl flex items-center justify-center mb-3 mx-auto group-hover:scale-110 group-hover:rotate-3 transition-all shadow-lg`}
                    aria-hidden="true"
                  >
            ...
            >
              ...
              <div
                className="absolute inset-0 bg-gradient-to-r from-blue-600 to-cyan-600 opacity-0 group-hover:opacity-100 transition-opacity rounded-xl"
                aria-hidden="true"
              ></div>
            </a>
          </div>
          ...
          <div className="relative group order-2 lg:order-1">
            <div
              className="absolute -inset-4 bg-gradient-to-r from-cyan-400/20 to-blue-400/20 rounded-3xl blur-2xl group-hover:blur-3xl transition-all"
              aria-hidden="true"
            ></div>
            <div className="relative">
              <div
                className="absolute inset-0 bg-gradient-to-br from-cyan-500/10 via-transparent to-blue-500/10 rounded-3xl"
                aria-hidden="true"
              ></div>
              <img
                src="/see.png"
